...
def get_credentials():
    """
    Only Web Input (sys.argv)
    """

    if len(sys.argv) < 3:
        print("❌ No UID/PASSWORD provided from Web Panel!")
        return None, None

    uid = sys.argv[1]
    password = sys.argv[2]

    print("🌐 [WEB MODE] Credentials received")
    print(f"👤 UID: {uid}")
...
# Load credentials from file
	print("🔐 Loading credentials from Web Panel...")

if len(sys.argv) < 3:
    print("❌ No UID/PASSWORD provided!")
    return None
...
Pw = sys.argv[2]
    ...
    os.system('clear')
    print("🤖 FIREJISAN20 BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 FIREJISAN20 BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
