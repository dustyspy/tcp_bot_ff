...
from MAINUL9X import DEcwHisPErMsG_pb2 , MajoRLoGinrEs_pb2 , PorTs_pb2 , MajoRLoGinrEq_pb2 , sQ_pb2 , Team_msg_pb2, RemoveFriend_Req_pb2, GetFriend_Res_pb2, spam_request_pb2, devxt_count_pb2, dev_generator_pb2, kyro_title_pb2, room_join_pb2
...
def load_credentials_from_file(filename="MAINUL9X.txt"):
    """
    Load UID and password from MAINUL9X.txt file
    """
    try:
        if not os.path.exists(filename):
        ...
        # যদি uid বা password না পাওয়া যায়
        if not uid or not password:
            print(f"[ERROR] Credentials not found in {filename}")
            print("[INFO] Please add your account details in this format:")
            print("  uid=YOUR_UID,password=YOUR_PASSWORD")
            print("  OR")
            print("  uid: YOUR_UID")
            print("  password: YOUR_PASSWORD")
            print("[MAINUL-X] Credential check failed")
            return None, None

        print(f"[SUCCESS] Credentials loaded successfully from {filename}")
        print(f"[ACCOUNT UID] {uid}")
        print(f"[PASSWORD] {password}")
        print("[SYSTEM] MAINUL-X BOT authentication ready")
...
📱 Player will see:
"MAINUL 9X wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ⚡ WELCOME TO [FFFFFF]MAINUL - X BOT [00FF00]___ POWERED BY MAINUL-X ___\n[FFFF00]NEW VERSION • ADVANCED FUNCTIONS ENABLED!\n[FF0000]CONTACT TELEGRAM : @mdmainulislaminfo\n\n"   
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
# -------------------------------------------------
async def youtube_info_command():
    ...
    main_info = f"""
[B][C][00BFFF]YOUTUBE INFO
Channel : {response_json.get('channel_title','Unknown')}
...
[FF1493]═════════════
[C][B][FFFFFF]👨‍💻 Developer   : [FF0000]MAINUL - X
[C][B][FFFFFF]🌐 GitHub      : [00BFFF]github.com/M41NUL
""".strip()
...
async def RejectMSGtaxt(squad_owner,uid, key, iv):
    random_banner = f"""
[B][C][FF0000]╔══════════════════════╗
[B][C][00FF00]      MAINUL - X BOT
[B][C][FF0000]╚══════════════════════╝

[C][B][00BFFF]🤖 Bot Status : [00FF00]ONLINE
[C][B][FFFFFF]⚡ Version     : [FFFF00]MAINUL-X V4
[C][B][FFFFFF]👨‍💻 Developer  : [FF0000]Md. Mainul Islam
[C][B][FFFFFF]🌐 GitHub     : [00BFFF]github.com/M41NUL
[C][B][FFFFFF]📩 Telegram   : [00FFFF]@mdmainulislaminfo

[C][B][FFD700]✨ Enjoy the game & have fun!
"""
    fields = {
    1: 5,
    2: {
...
async def convert_kyro_to_your_system(target_uid, chat_id, key, iv, nickname="MAINUL_9X", title_id=None):
...
async def send_sticker(target_uid, chat_id, key, iv, nickname="MAUNUL"):
...
async def send_kyro_title_adapted(chat_id, key, iv, target_uid, nickname="MaiNul"):
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="FIREJISAN20", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="FIREJISAN20", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde FIRE GAMER ya meku agar tu noob bolra toh tu g a y hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="FIREJISAN20", title_id=title_id)
...
async def set_bio_directly_async(jwt_token, bio_text, region="IND"):
    ...
    try:
        ...
        print("⚡ System: MAINUL - X BOT")
        print("🌐 GitHub: github.com/M41NUL")
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if "MĢ24_GÀMER" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to JISAN "
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][00FF00]WELCOME TO MAINUL - X BOT
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFFFF]BOT SYSTEM: [FF0000]MAINUL - X BOT
[FFFFFF]STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]COMMANDS: [FFFF00]/help /ping /info
[FFFFFF]DEVELOPER: [FFD700]MAINUL
[FFFFFF]TELEGRAM: [00FFFF]@MAINUL - X
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700]THANKS FOR USING MAINUL - X BOT"""
...
Features:
• Changes bot profile bio instantly
• Supports text and special characters
...
"""
                                ...
                                credentials = load_credentials_from_file("FIREJISAN20.txt")
                                if not credentials:
...
"""
                            ...
                            if str(response.Data.uid) != "8481186918":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "8481186918":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "8481186918":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {xMsGFixinG(uid)}"
                                    count += 1
                                    if count >= 20:
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[B][C][FFC0CB]MAINUL - X BOT

Need a custom bot or private panel?
Contact the developer.

[FFFFFF]Developer : MAINUL - X
[00BFFF]GitHub    : github.com/M41NUL
[00FFFF]Telegram  : @MAINUL-X
...
#==================≈===========  /HELP MENU COMMANDS ========================================
    ...
    # Header
                            header = f"[b][c]{get_random_color()}Hello User Welcome To MAINUL - X 's BOT"
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

    # ───── Commands 1-10 ─────
                            help_1 = """
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[B][FFFFFF]0🤫1🤫. Get Likes [00FF00]/like [uid]
[B][FFFFFF]0🤫2🤫. Group Limit [FF0000]🤫/3 🤫/5 🤫/6🤫
[B][FFFFFF]0🤫3🤫. Player Info [00CCFF]/info [uid]
[B][FFFFFF]0🤫4🤫. Check Ban [00FF00]/check [uid]
[B][FFFFFF]0🤫5🤫. Player Invite [00CCFF]/inv [uid]
[B][FFFFFF]0🤫6🤫. Msg Spam [00FF00]/ms [msg]
[B][FFFFFF]0🤫7🤫. Unlock 5v🤫5 [FFFF00]/snd [uid]
[B][FFFFFF]0🤫8🤫. Admin [00CCFF]/admin
[B][FFFFFF]0🤫9🤫. Join Team [FFFF00]/join [TeamCode]
[B][FFFFFF]1🤫0🤫. Leave Group [FF0000]/exit
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[B][FFFFFF]1🤫1🤫. Req Spam [00FF00]/spam [uid]
[B][FFFFFF]1🤫2🤫. Kick Player [FF6600]/kick [uid]
[B][FFFFFF]1🤫3🤫. Lag Calive [00FF00]/lag [TeamCode]
[B][FFFFFF]1🤫4🤫. Join Req Spam [FF00FF]/spam_join [uid]
[B][FFFFFF]1🤫5🤫. Attack Group [FFFFFF]/attack [TeamCode]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]            
[B][FFFFFF]1🤫6🤫. Force Start [FFCC00]/start [TeamCode]
[B][FFFFFF]1🤫7🤫. Times Emote [FF0000]/p [uid] [emote] [count]
[B][FFFFFF]1🤫8🤫. Add Bot Friend [00FF00]/add [uid]
[B][FFFFFF]1🤫9🤫. Remove Friend [FF00FF]/remove [uid]
[B][FFFFFF]2🤫0🤫. Player Status [00CCFF]/status [uid]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]            
[B][FFFFFF]2🤫1🤫. Add Ghost in Team [00FFFF]/ghost [TeamCode]
[B][FFFFFF]2🤫2🤫. Bundle [00FF00]/bundle
[B][FFFFFF]2🤫3🤫. EVO Cycle [00CCFF]/evos [uid]
[B][FFFFFF]2🤫4🤫. Stop Evo Cycle [00FFFF]/sevos
[B][FFFFFF]2🤫5🤫. Emote Play [00FF00]/play [uid] [1-410]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]           
[B][FFFFFF]2🤫6🤫. Emote Command [00CCFF]/emote [UID1] [UID2] [TeamCode] [EmoteNumber]
[B][FFFFFF]2🤫7🤫. EVO Emote [00FF00]/evo [UID1] [UID2] [EmoteNumber]
[B][FFFFFF]2🤫8🤫. Play Emote (ID) [CC33FF]/e [UID1] [UID2] [EmoteID]
[B][FFFFFF]2🤫9🤫. Fast Play [00FF00]/fast [UID1] [UID2] [EmoteID]
[B][FFFFFF]3🤫0🤫. Chat With AI [FF00FF]/ai [question]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]           
[B][FFFFFF]3🤫1🤫. CL Badge Join [FF0000]/s1 [uid]
[B][FFFFFF]3🤫2🤫. V Badge Join [00FF00]/s2 [uid]
[B][FFFFFF]3🤫3🤫. Mdtr Badge Join [0000FF]/s3 [uid]
[B][FFFFFF]3🤫4🤫. Old V Badge Join [FFFF00]/s4 [uid]
[B][FFFFFF]3🤫5🤫. Pro Badge Join [00AAFF]/s5 [uid]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]            
[B][FFFFFF]3🤫6🤫. All Badge Join [FF0000]/spam [uid]
[B][FFFFFF]3🤫7🤫. Gali Friend [00CCFF]/gali [name]
[B][FFFFFF]3🤫8🤫. Private Message [FFFF00]/dm [msg]
[B][FFFFFF]3🤫9🤫. Equip Bundle [FF0000]/bundle [name]
[B][FFFFFF]4🤫0🤫. Admin Mode On [00CCFF]/adon
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]               
[B][FFFFFF]4🤫1🤫. Admin Mode Off [FFFF00]/adoff
[B][FFFFFF]4🤫2🤫. On Bot [00FF00]/on
[B][FFFFFF]4🤫3🤫. Off Bot [FF0000]/off
[B][FFFFFF]4🤫4🤫. Block User [00FFFF]/block [uid]
[B][FFFFFF]4🤫5🤫. Unblock User [00FF00]/unblock [uid]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]                
[B][FFFFFF]4🤫6🤫. Set Bundle [00FF00]/bundle [name]
[B][FFFFFF]4🤫7🤫. Lag Team [FF6600]/lag [TeamCode]
[B][FFFFFF]4🤫8🤫. Attack Team [00FF00]/attack [TeamCode]
[B][FFFFFF]4🤫9🤫. Level Up Bot [FFFF00]/lw [TeamCode]
[B][FFFFFF]5🤫0🤫. Stop Level Up Bot [FF0000]/stop
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]                
[B][FFFFFF]5🤫1🤫. Bundle Spam [00FF00]/bb_lag [TeamCode]5🤫2🤫. TCP Store [FF00FF]/store
[B][FFFFFF]5🤫3🤫. Spam Invite [00CCFF]/spm_inv [uid]
[B][FFFFFF]5🤫4🤫. Spam Friend Requests [FFFF00]/spam_req [uid]
[B][FFFFFF]5🤫5🤫. Spam Join Requests [00FF00]/spam_join [uid]
[B][FFFFFF]5🤫6🤫. Play Emote Self [FF00FF]/e [emote]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
"""
...
[[B][C][1E90FF]⚡MAINUL - X BOT COMMANDS⚡[FFFFFF]][/B][/C]
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]   
[B][FFFFFF]5🤫7🤫. Play Emote Player [00FF00]/e [uid] [emote]
[B][FFFFFF]5🤫8🤫. Play Emote Without Bot [FF6600]/me [TeamCode] [emote]
[B][FFFFFF]5🤫9🤫. Player Emote Without Bot [00FF00]/me [tc] [uid] [emote]
[B][FFFFFF]6🤫0🤫. Evo Cycle Self [FF00FF]@evos
[B][FFFFFF]6🤫1🤫. Evo Cycle Player [00FF00]@evos [uid]
[B][FFFFFF]6🤫2🤫. Stop Evo Cycle [FF0000]@sevos
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
    """
                            await safe_send_message(response.Data.chat_type, help_11, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

    # Footer
                            footer = """[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]⚡[B][C][FFFF00]BOT INFO[FFFF00][/B][/C] ⚡

[FFFF00]👤 Developer :: [FF1493]MAINUL
[32CD32]💻 Status    	:: [32CD32]ONLINE
[1E90FF]🛠 Version    :: [1E90FF]MAINUL TCP V4
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from MAINUL9X.txt...")
    credentials = load_credentials_from_file("MAINUL9X.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create FIREJISAN20.txt with your UID and password")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 MAINUL - X BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖  MAINUL - X BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ░░░M░░░A░░░I░░░N░░░   ░░░░░U░░░░░L░░░░░-░░░░░X░░░░░BOT░░░ │")
    print("└────────────────────────────────────┘")
    ...
    print("💡 Type /𝙝𝙚𝙡𝙥 for command list")
    print("=" * 50)
